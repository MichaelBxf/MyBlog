'use strict';
const version = 'v201705141723';
const __DEVELOPMENT__ = false;const __DEBUG__ = false;const offlineResources = ['/', '/offline.html', '/offline.svg'];const ignoreFetch = [/https?:\/\/piwik.nfz.moe\//, /https?:\/\/neofelhzblog.disqus.com\//, /chrome-extension:\/\//];
